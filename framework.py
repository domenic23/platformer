...
# platforms = [Rect(random.randint(0, WIDTH), random.randint(0, HEIGHT), 100, 10) for _ in range(20)]

# for platform in platforms:
#     pg.draw.rect(scaled, 'green', platform)

# walkers = [Walker(platform) for platform in platforms]
